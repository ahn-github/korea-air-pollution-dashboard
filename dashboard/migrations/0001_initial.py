# Generated by Django 2.1.4 on 2018-12-10 13:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('covalue', models.DecimalField(blank=True, db_column='coValue', decimal_places=3, max_digits=10, null=True)),
                ...
                ('no2value', models.DecimalField(blank=True, db_column='no2Value', decimal_places=3, max_digits=10, null=True)),
                ('o3grade', models.IntegerField(blank=True, db_column='o3Grade', null=True)),
                ('o3value', models.DecimalField(blank=True, db_column='o3Value', decimal_places=3, max_digits=10, null=True)),
                ...
                ('so2value', models.IntegerField(blank=True, db_column='so2Value', null=True)),
